...
while True: 
  ...
  if choice_mode == 5:
    ...
    while True:
      ...
      print('')
      achievment(Fore.YELLOW + '  |-------------------- SUPER GAMER ---------------------|' + Fore.RESET, G_games, 1000, '          >>> play 1000 games in anything mode <<<')
      achievment(Fore.YELLOW + '  |-------------------- GIGA WINNER ---------------------|' + Fore.RESET, G_wins, 100, '           >>> win 100 games in anything mode <<<')
      achievment(Fore.YELLOW + '  |-------------------- GIGA LOOSER ---------------------|' + Fore.RESET, G_losses, 100, '          >>> lose 100 games in anything mode <<<')
      achievment(Fore.YELLOW + '  |------------------ BIG-BIG DRAWERS -------------------|' + Fore.RESET, big_draw, 30, '          >>> get 30 Big Draw in Best of N mode <<<')
      achievment(Fore.YELLOW + '  |------------------ WASTE_TIME_GAMER ------------------|' + Fore.RESET, hours, 3, '               >>> spend 3 hours in game <<<')
      achievment(Fore.YELLOW + '  |------------------- MAIN SLOWPOCE --------------------|' + Fore.RESET, Slowpoce, 100, '           >>> wait too long in Two Hand mode <<<')
      achievment(Fore.YELLOW + '  |-------------------- THE TESTER ----------------------|' + Fore.RESET, errors, 100, '               >>> get 100 errors in game <<<')
